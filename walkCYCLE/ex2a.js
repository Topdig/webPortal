...
lib.ssMetadata = [
		{name:"ex2a_atlas_", frames: [[0,0,406,484],[0,486,345,466],[588,486,238,477],[347,486,239,525],[408,0,406,484]]}
];
...
(lib.CachedTexturedBitmap_77 = function() {
	this.initialize(ss["ex2a_atlas_"]);
	this.gotoAndStop(0);
...
(lib.Scene_1_Layer_1 = function(mode,startPosition,loop) {
	...
	this.instance_2.setTransform(130.3,95.85,0.5,0.5);
...
// stage content:
(lib.ex2a = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/ex2a_atlas_.png?1552890866642", id:"ex2a_atlas_"}
	],
	preloads: []
};
