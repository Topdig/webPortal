...
lib.ssMetadata = [
		{name:"RECOVER_ex2a_atlas_", frames: [[0,0,406,484],[0,486,345,466],[588,486,238,477],[347,486,239,525],[408,0,406,484]]}
];
...
(lib.CachedTexturedBitmap_1 = function() {
	this.initialize(ss["RECOVER_ex2a_atlas_"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.RECOVER_ex2a = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/RECOVER_ex2a_atlas_.png?1552982598548", id:"RECOVER_ex2a_atlas_"}
	],
	preloads: []
};
